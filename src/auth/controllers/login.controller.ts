...
export const loginUser = catchController(async (req: Request, res: Response) => {
  ...
  if (user?.role !== 'user') {
    return res
      ...
      .json(generalResponse(StatusCodes.NOT_FOUND, {}, [], errorMessages.INVALID_CREDENTIALS_ERROR))
  }
  ...
  if (!user.password || typeof user.password !== 'string') {
    return res
      ...
      .json(
        generalResponse(StatusCodes.UNAUTHORIZED, {}, [], errorMessages.INVALID_CREDENTIALS_ERROR),
      )
  }
...
export const getAccessToken = catchController(async (req: Request, res: Response) => {
